...
if __name__ == '__main__':
    ...
    reference_params = {}
    reference_params['ub'] = [  -11.4*beta, -4.53*beta, -4.95*beta ]
    reference_params['sb'] = [ 3.17*beta,  4.84*beta, 3.90*beta ]
    reference_params['pb'] = [ 8.68e-10, 3.69e-14, 1.38e-13 ]
    reference_params['elj'] = [ 10*beta, 30*beta, 30*beta ]
    reference_params['uce'] = [ 1.0,    20.0, 20.0 ]
    reference_params['nl']  = [   5,    30, 30 ]
    reference_params['wg'] =  [ 3.92e-6, 8.28e-3, 9.92e-1 ]
    
    scale_params = {}
    scale_params['ub'] =  [ 1.*beta, 1.*beta, 1.*beta ]
    scale_params['sb'] =  [ 0.1*beta, 0.1*beta, 0.1*beta ]
    scale_params['pb'] =  [ 1.e-10, 1.e-14, 1.e-14  ]
    ...
    range_params = {}
    range_params['ub'] = [ (-12.0*beta, 30.0*beta), (-6.0*beta, 30.0*beta), (-6.0*beta, 30.0*beta) ]
    range_params['sb'] = [ (1.0*beta, 8.0*beta), (1.0*beta, 8.0*beta), (1.0*beta, 8.0*beta) ]
