...
if __name__ == '__main__':
    ...
    reference_params = {}
    reference_params['ub'] = [  -6.05*beta, -6.32*beta, 0.701*beta ]
    reference_params['sb'] = [ 3.96*beta,  4.78*beta, 5.20*beta ]
    reference_params['pb'] = [ 5.52e-6, 2.65e-14, 8.61e-18 ]
    reference_params['elj'] = [ 10*beta, 30*beta, 30*beta ]
    reference_params['uce'] = [ 1.0,    20.0, 20.0 ]
    reference_params['nl']  = [   5,    30, 30 ]
    reference_params['wg'] =  [ 5.23e-8, 1.33e-4, 9.99e-1 ]
    
    scale_params = {}
    scale_params['ub'] =  [ 1.*beta, 1.*beta, 1.*beta ]
    scale_params['sb'] =  [ 0.1*beta, 0.1*beta, 0.1*beta ]
    scale_params['pb'] =  [ 1.e-6, 1.e-14, 1.e-18  ]
    scale_params['elj'] = [ 1*beta, 1*beta, 1*beta ]
    scale_params['uce'] = [ 1, 1, 1 ]
    scale_params['nl']  = [ 1, 1, 1 ]
    scale_params['wg'] =  [ 1.e-8, 1.e-4, 1.e-1 ]

    range_params = {}
    range_params['ub'] = [ (-6.5*beta, 30.0*beta), (-6.5*beta, 30.0*beta), (-6.5*beta, 30.0*beta) ]
